...
pub(crate) struct Strings {
    ...
    pub btn_copy_launch_command: &'static str,
    ...
    pub menu_copy_launch_command: &'static str,
    ...
    pub status_copied_launch_fmt: &'static str,
    pub status_copy_fail: &'static str,
...
impl Strings {
    const fn en() -> Self {
        Self {
            ...
            btn_copy_launch_command: "Copy launch command",
            ...
            menu_copy_launch_command: "Copy Launch Command",
            ...
            status_copied_launch_fmt: "Copied launch command for {} to clipboard.",
            status_copy_fail: "Could not copy to clipboard.",
    ...
    const fn zh() -> Self {
        Self {
            ...
            btn_copy_launch_command: "复制启动命令",
            ...
            menu_copy_launch_command: "复制启动命令",
            ...
            status_copied_launch_fmt: "已复制 {} 的启动命令到剪贴板。",
            status_copy_fail: "无法复制到剪贴板。",
