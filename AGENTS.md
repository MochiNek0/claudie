...
- Mood transitions should go through `AppState::set_mood`, `AppState::start_tool_mood`, `AppState::finish_tool_mood`, or `AppState::decay_mood` so activity timestamps and renderer priority stay correct.
